...
start_time=Sys.time()
ts1409copy = interpolate(ts1409, t.window=548, s.window=30*38)
end_time = Sys.time()
end_time - start_time
```
...
```{r, echo=TRUE}
par(mfrow = c(1,2))
plot(ts1409, type="b", col="green", xlim=c(1997,2000))
plot(ts1409copy, type="b", col="blue",xlim=c(1997,2000), ylim=c(-4,4))
